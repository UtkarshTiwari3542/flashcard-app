...
<body>
    ...
    @if ($errors->any())
        <div>
            <strong>Error!</strong> Please fill in all fields.<br><br>
            <ul>
...
<body>
    <div class="form-container">
        <div class="header">
            <h1 class="page-title">Create New Flashcard</h1>
        </div>
        ...
        <form action="{{ route('flashcards.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="question" name="question" value="{{ old('question') }}" placeholder="Enter your question here..." autofocus>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="answer" name="answer" value="{{ old('answer') }}" placeholder="Enter your answer here...">
            </div>
            ...
            <div class="card-preview">
                ...
                <div class="preview-content">
                    <div class="preview-card">
                        ...
                        <p class="preview-text" id="question-preview">
                            <span class="empty-text">Your question will appear here</span>
                        </p>
                    </div>
                    <div class="preview-card">
                        <span class="preview-label">Answer</span>
                        <p class="preview-text" id="answer-preview">
                            <span class="empty-text">Your answer will appear here</span>
                        </p>
                    </div>
                </div>
            </div>
